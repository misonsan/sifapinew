...
use App\Models\t_ruoloday;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use Illuminate\Support\Facades\DB;

class TRuolodayController extends Controller
{
      /**
        ...
        $res = [
            ...
            try{
               ...
               // lettura con join a tabelle correlate
                $res['data'] = DB::table('t_ruolodays')
                                   ->select('t_ruolodays.*')
                                  ->get();

                $res['number'] = t_ruoloday::All()->count();  // Fedele::where('idmessa',$idmessa->input('idmessa'))->count();
    ...
    public function show($id)
    {
        $res = [
          ...
          try{
           ...
           $res['data'] =  t_ruoloday::select('t_ruolodays.*')
                                      ->findOrFail($id);
         } catch (\Exception $e){
