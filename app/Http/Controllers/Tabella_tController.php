...
use App\Models\Tabella_t;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use Illuminate\Support\Facades\DB;


class Tabella_tController extends Controller
{
    /**
        ...
        $res = [
            ...
            try{
               ...
               // lettura con join a tabelle correlate
                $res['data'] = DB::table('Tabella_ts')
                                  ->select('tabella_ts.*')
                                  ->get();

                $res['number'] = Tabella_t::All()->count();  // Fedele::where('idmessa',$idmessa->input('idmessa'))->count();
     ...
     *
     * @param  \App\Models\Tabella_t  $tabella_t
     * @return \Illuminate\Http\Response
     */
    public function show($id)
    {
                         ...
                         $res = [
                          ...
                          try{
                           ...
                           $res['data'] = Tabella_t::select('Tabella_ts.*')
                                                     ->findOrFail($id);
                         } catch (\Exception $e){
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Tabella_t $tabella_t)
    {
        //
    }
