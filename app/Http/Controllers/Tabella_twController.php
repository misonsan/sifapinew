...
use App\Models\Tabella_tw;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use Illuminate\Support\Facades\DB;


class Tabella_twController extends Controller
{
    /**
        ...
        $res = [
            ...
            try{
               ...
               // lettura con join a tabelle correlate
                $res['data'] = DB::table('Tabella_tws')
                                  ->select('tabella_tws.*')
                                  ->get();

                $res['number'] = Tabella_tw::All()->count();  // Fedele::where('idmessa',$idmessa->input('idmessa'))->count();
                $res['message'] = 'trovato tabelle di servizio';
            } catch (\Exception $e){
     ...
     *
     * @param  \App\Models\Tabella_tw  $tabella_tw
     * @return \Illuminate\Http\Response
     */
    public function show($id)
    {
                         ...
                         $res = [
                          ...
                          try{
                           ...
                           $res['data'] = Tabella_tw::select('Tabella_tws.*')
                                                     ->findOrFail($id);
                         } catch (\Exception $e){
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Tabella_tw $tabella_tw)
    {
        //
    }
